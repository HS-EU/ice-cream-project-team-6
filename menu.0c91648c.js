...
(function () {
  var menuBtnOpen = document.querySelector('[menu-button-open]');
  var menuBtnClose = document.querySelector('[menu-button-close]');
  var mobileMenuRef = document.querySelector('[data-menu]');
  menuBtnOpen.addEventListener('click', function () {
    var expanded = menuBtnOpen.getAttribute('aria-expanded') === 'true' || false;
    var expanded2 = menuBtnClose.getAttribute('aria-expanded') === 'false' || true;
